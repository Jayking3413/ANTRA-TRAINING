...
--10. Write a query that retrieves the columns Name and ListPrice from the Production.Product table. Your result set should look something like the following. Order the result set
...
SELECT ISNULL(ProductSubcategoryID, 0) IDnum, ISNULL(Color,'N/A') Color
FROM Production.Product
